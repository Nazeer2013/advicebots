...
def analyze_sentiment(audio_file):
    ...
    if result.reason == speechsdk.ResultReason.RecognizedSpeech:
        ...
        return {"Text": "", "Sentiment": "Sorry, I didn't catch that. Please try again."}
    elif result.reason == speechsdk.ResultReason.Canceled:
        return {"Text": "", "Sentiment": "Sorry, there was an error. Please try again."}
...
iface = gr.Interface(analyze_sentiment, inputs=gr.inputs.Audio(label="Speak into your microphone"), outputs=["text", "text"], title="Speech Sentiment Analysis")
iface.launch()
